...
# Create subheaders for main performance indicator  
    new_title = '<p style="font-family:monospace; color:#FF4B4B; font-size: 30px;"><b>Key Performance Indicators</b></p>'
    st.markdown(new_title, unsafe_allow_html=True)
