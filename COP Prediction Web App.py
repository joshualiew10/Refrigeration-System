...
def LiqLoss_prediction(input_data):
    LiqLoss_model=tf.keras.models.load_model('C:/Users/joshu/Desktop/Streamlit/Keras ANN Model/LiqLoss/LiqLoss_model.h5')
    scaler_LiqLoss=pickle.load(open('C:/Users/joshu/Desktop/Streamlit/Keras ANN Model/LiqLoss/scaler_LiqLoss.sav','rb'))
    input_data_as_numpy_array=np.asarray(input_data)
...
def D0001T_prediction(input_data):
    D0001T_model=pickle.load(open('C:/Users/joshu/Desktop/Streamlit/Keras ANN Model/D0001T/D0001T_model.sav','rb'))
    scaler_D0001T=pickle.load(open('C:/Users/joshu/Desktop/Streamlit/Keras ANN Model/D0001T/scaler_D0001T.sav','rb'))
    input_data_as_numpy_array=np.asarray(input_data)
...
def D0002T_prediction(input_data):
    D0002T_model=pickle.load(open('C:/Users/joshu/Desktop/Streamlit/Keras ANN Model/D0002T/D0002T_model.sav','rb'))
    scaler_D0002T=pickle.load(open('C:/Users/joshu/Desktop/Streamlit/Keras ANN Model/D0002T/scaler_D0002T.sav','rb'))
    input_data_as_numpy_array=np.asarray(input_data)
...
def D0003T_prediction(input_data):
    D0003T_model=tf.keras.models.load_model('C:/Users/joshu/Desktop/Streamlit/Keras ANN Model/D0003T/D0003T_model.h5')
    scaler_D0003T=pickle.load(open('C:/Users/joshu/Desktop/Streamlit/Keras ANN Model/D0003T/scaler_D0003T.sav','rb'))
    input_data_as_numpy_array=np.asarray(input_data)
...
def D0004T_prediction(input_data):
    D0004T_model=pickle.load(open('C:/Users/joshu/Desktop/Streamlit/Keras ANN Model/D0004T/D0004T_model.sav','rb'))
    scaler_D0004T=pickle.load(open('C:/Users/joshu/Desktop/Streamlit/Keras ANN Model/D0004T/scaler_D0004T.sav','rb'))
    input_data_as_numpy_array=np.asarray(input_data)
...
def D0005T_prediction(input_data):
    D0005T_model=pickle.load(open('C:/Users/joshu/Desktop/Streamlit/Keras ANN Model/D0005T/D0005T_model.sav','rb'))
    scaler_D0005T=pickle.load(open('C:/Users/joshu/Desktop/Streamlit/Keras ANN Model/D0005T/scaler_D0005T.sav','rb'))
    input_data_as_numpy_array=np.asarray(input_data)
...
def D0001P_prediction(input_data):
    D0001P_model=pickle.load(open('C:/Users/joshu/Desktop/Streamlit/Keras ANN Model/D0001P/D0001P_model.sav','rb'))
    scaler_D0001P=pickle.load(open('C:/Users/joshu/Desktop/Streamlit/Keras ANN Model/D0001P/scaler_D0001P.sav','rb'))
    input_data_as_numpy_array=np.asarray(input_data)
...
def D0002P_prediction(input_data):
    D0002P_model=pickle.load(open('C:/Users/joshu/Desktop/Streamlit/Keras ANN Model/D0002P/D0002P_model.sav','rb'))
    scaler_D0002P=pickle.load(open('C:/Users/joshu/Desktop/Streamlit/Keras ANN Model/D0002P/scaler_D0002P.sav','rb'))
    input_data_as_numpy_array=np.asarray(input_data)
...
def D0003P_prediction(input_data):
    D0003P_model=pickle.load(open('C:/Users/joshu/Desktop/Streamlit/Keras ANN Model/D0003P/D0003P_model.sav','rb'))
    scaler_D0003P=pickle.load(open('C:/Users/joshu/Desktop/Streamlit/Keras ANN Model/D0003P/scaler_D0003P.sav','rb'))
    input_data_as_numpy_array=np.asarray(input_data)
...
def D0004P_prediction(input_data):
    D0004P_model=pickle.load(open('C:/Users/joshu/Desktop/Streamlit/Keras ANN Model/D0004P/D0004P_model.sav','rb'))
    scaler_D0004P=pickle.load(open('C:/Users/joshu/Desktop/Streamlit/Keras ANN Model/D0004P/scaler_D0004P.sav','rb'))
    input_data_as_numpy_array=np.asarray(input_data)
...
def D0005P_prediction(input_data):
    D0005P_model=pickle.load(open('C:/Users/joshu/Desktop/Streamlit/Keras ANN Model/D0005P/D0005P_model.sav','rb'))
    scaler_D0005P=pickle.load(open('C:/Users/joshu/Desktop/Streamlit/Keras ANN Model/D0005P/scaler_D0005P.sav','rb'))
    input_data_as_numpy_array=np.asarray(input_data)
...
def EB001_prediction(input_data):
    EB001_model=pickle.load(open('C:/Users/joshu/Desktop/Streamlit/Keras ANN Model/EB001/EB001_model.sav','rb'))
    scaler_EB001=pickle.load(open('C:/Users/joshu/Desktop/Streamlit/Keras ANN Model/EB001/scaler_EB001.sav','rb'))
    input_data_as_numpy_array=np.asarray(input_data)
...
def EB002_prediction(input_data):
    EB002_model=pickle.load(open('C:/Users/joshu/Desktop/Streamlit/Keras ANN Model/EB002/EB002_model.sav','rb'))
    scaler_EB002=pickle.load(open('C:/Users/joshu/Desktop/Streamlit/Keras ANN Model/EB002/scaler_EB002.sav','rb'))
    input_data_as_numpy_array=np.asarray(input_data)
...
def EB003_prediction(input_data):
    EB003_model=pickle.load(open('C:/Users/joshu/Desktop/Streamlit/Keras ANN Model/EB003/EB003_model.sav','rb'))
    scaler_EB003=pickle.load(open('C:/Users/joshu/Desktop/Streamlit/Keras ANN Model/EB003/scaler_EB003.sav','rb'))
    input_data_as_numpy_array=np.asarray(input_data)
...
def EB004_prediction(input_data):
    EB004_model=pickle.load(open('C:/Users/joshu/Desktop/Streamlit/Keras ANN Model/EB004/EB004_model.sav','rb'))
    scaler_EB004=pickle.load(open('C:/Users/joshu/Desktop/Streamlit/Keras ANN Model/EB004/scaler_EB004.sav','rb'))
    input_data_as_numpy_array=np.asarray(input_data)
...
def EB005_prediction(input_data):
    EB005_model=pickle.load(open('C:/Users/joshu/Desktop/Streamlit/Keras ANN Model/EB005/EB005_model.sav','rb'))
    scaler_EB005=pickle.load(open('C:/Users/joshu/Desktop/Streamlit/Keras ANN Model/EB005/scaler_EB005.sav','rb'))
    input_data_as_numpy_array=np.asarray(input_data)
...
def Condenser_prediction(input_data):
    Condenser_model=pickle.load(open('C:/Users/joshu/Desktop/Streamlit/Keras ANN Model/Condenser/Condenser_model.sav','rb'))
    scaler_Condenser=pickle.load(open('C:/Users/joshu/Desktop/Streamlit/Keras ANN Model/Condenser/scaler_Condenser.sav','rb'))
    input_data_as_numpy_array=np.asarray(input_data)
...
def VF_prediction(input_data):
    VF_model=pickle.load(open('C:/Users/joshu/Desktop/Streamlit/Keras ANN Model/VF/VF_model.sav','rb'))
    scaler_VF=pickle.load(open('C:/Users/joshu/Desktop/Streamlit/Keras ANN Model/VF/scaler_VF.sav','rb'))
    input_data_as_numpy_array=np.asarray(input_data)
